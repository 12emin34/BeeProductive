...
public class BeeProdBlocks {
    public static final Block BEE_FEEDER = register("bee_feeder", new BeeFeederBlock(FabricBlockSettings.of(Material.WOOD).breakByTool(FabricToolTags.AXES).nonOpaque().noCollision()), BeeProdItems.TOOLS_GROUP);
